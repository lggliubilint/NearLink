...
class _DashboardPageState extends State<DashboardPage> with SingleTickerProviderStateMixin {
  ...
  Color _accent() => widget.fallProb > 0.7 ? AppTheme.red : widget.fallProb > 0.3 ? AppTheme.amber : AppTheme.cyan;
          ...
          Expanded(
            child: GlassCard(
              child: Column(children: [
                ...
                _fallGauge(),
                SizedBox(height: 4.h),
                Text("${(widget.fallProb * 100).toInt()}%", style: AppTheme.mono(28, _accent())),
              ]),
            ),
          ),
          SizedBox(width: 8.w),
